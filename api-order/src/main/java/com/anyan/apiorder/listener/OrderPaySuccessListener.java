...
import static com.anyan.apicommon.constant.RabbitmqConstant.QUEUE_ORDER_PAY_SUCCESS;
...
public class OrderPaySuccessListener {
    ...
    @RabbitListener(queuesToDeclare = {@Queue(QUEUE_ORDER_PAY_SUCCESS)})
    public void receiveOrderMsg(String outTradeNo, Message message, Channel channel) throws IOException {
        ...
        boolean updateInvokeCount = apiBackendService.updateUserInterfaceInfoInvokeCount(userId, interfaceId, count);
