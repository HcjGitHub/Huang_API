package com.anyan.apicommon.utils;
...
public class JwtUtils {
    ...
    public static final String SECRET_KEY = "LaoHuang-Api"; //秘钥
     ...
     * @param username 用户名
     */
    public static String createJwtToken(Long id, String username) {
...
//               jti：JWT ID用于标识该JWT
     ...
     * @return
     */
    public static Long parserUserIdByToken(HttpServletRequest request) {
